...
<body>
    ...
    <main>
    <?php
        $multiplicacaoA = $_POST['multiplicacaoA'];
        $multiplicacaoB = $_POST['multiplicacaoB'];

        if ($multiplicacaoA >= 0 && $multiplicacaoB >= 0) {
            $resultadoMULTIPLICACAO = $multiplicacaoA * $multiplicacaoB;
            echo "A subtração é: ".$resultadoMULTIPLICACAO;
